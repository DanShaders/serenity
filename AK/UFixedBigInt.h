...
template<size_t divident_size, size_t divisor_size, bool restore_remainder>
constexpr void div_mod_internal( // Include AK/UFixedBigIntDivision.h to use UFixedBigInt division
    StaticStorage<false, divident_size> const& divident,
    StaticStorage<false, divisor_size> const& divisor,
    StaticStorage<false, divident_size>& quotient,
