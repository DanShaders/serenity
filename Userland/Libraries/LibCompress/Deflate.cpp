...
AsyncDeflateDecompressor::AsyncDeflateDecompressor(MaybeOwned<AsyncInputStream>&& input)
...
ReadonlyBytes AsyncDeflateDecompressor::buffered_data_unchecked(Badge<AsyncInputStream>) const
{
    return m_buffer.data();
}

void AsyncDeflateDecompressor::dequeue(Badge<AsyncInputStream>, size_t bytes)
{
    return m_buffer.dequeue(bytes);
}

auto AsyncDeflateDecompressor::decompress() -> Generator
{
    while (true) {
